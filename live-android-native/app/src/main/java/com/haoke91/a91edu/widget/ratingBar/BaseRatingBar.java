package com.haoke91.a91edu.widget.ratingBar;
...
public class BaseRatingBar extends LinearLayout implements SimpleRatingBar {
    ...
    private void verifyParamsValue() {
        ...
        if (mEmptyDrawable == null) {
            mEmptyDrawable = ContextCompat.getDrawable(getContext(), R.drawable.ic_start_gray);
            
        }
//        if (mEmptyDrawable != null) {
//            int width = (int) (mEmptyDrawable.getIntrinsicWidth() * 0.3);
//            int height = (int) (mEmptyDrawable.getIntrinsicHeight() * 0.3);
//            mEmptyDrawable.setBounds(0, 0, width, height);
//        }
        
        if (mFilledDrawable == null) {
            mFilledDrawable = ContextCompat.getDrawable(getContext(), R.drawable.ic_start_yellow);
        }
        
//        if (mFilledDrawable != null) {
//            int width = (int) (mFilledDrawable.getIntrinsicWidth() * 0.3);
//            int height = (int) (mFilledDrawable.getIntrinsicHeight() * 0.3);
//            mFilledDrawable.setBounds(0, 0, width, height);
//        }
