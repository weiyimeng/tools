...
import com.haoke91.a91edu.ui.business.alipay.Base64;
import com.haoke91.a91edu.ui.business.alipay.PayResult;
 ...
 * 类描述：支付宝支付
 * 创建人：weiyimeng
 * 创建时间：2018/5/21 下午7:53
 * 修改人：weiyimeng
 * 修改时间：2018/5/21 下午7:53
 * 修改备注：
 */
public class AliPayUtils {
    ...
    private Handler mHandler = new  Handler() {
        public void handleMessage(Message msg) {
            ...
            if (TextUtils.equals(resultStatus, "9000")) {
                ...
                PaySuccessActivity.Companion.start(context, builder.money);
            } else {
    ...
    public void toALiPay(final Activity context) {
        ...
        //        Map<String, String> params = OrderInfoUtil2_0.buildOrderParamMap(builder.getAppid(), rsa2);
