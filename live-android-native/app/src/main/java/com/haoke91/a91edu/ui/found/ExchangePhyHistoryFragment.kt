 ...
 * 修改备注：
 */
class ExchangePhyHistoryFragment : BaseLoadMoreFragment() {
    ...
    override fun fetchData() {
        ...
        mGridAdapter = ExchangeHistoryAdapter(mContext, 1)
        ...
        mGridAdapter.setOnItemClickListener { view, position -> GoodsDetailsActivity.start(mContext, mGridAdapter.getItem(position).id) }
