 ...
 * 修改备注：
 */
class ExchangeVirtualFragment : BaseLoadMoreFragment() {
    private val STARTPAGE = 1
    private var mCurrentPage = STARTPAGE
    private var mGridAdapter: ExchangeAdapter? = null
    private val LOADVIRTUALDATE = "loadvirtualdate"
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mGridAdapter = ExchangeAdapter(mContext, 2)
        ...
        rv_list.addItemDecoration(object : RecyclerView.ItemDecoration() {
            override fun getItemOffsets(outRect: Rect, view: View, parent: RecyclerView, state: RecyclerView.State?) {
                ...
                if (parent.getChildLayoutPosition(view) % 2 == 0) {
                    ...
                    outRect.right = DensityUtil.dip2px(mContext, 8f)
    ...
    fun clickRefresh() {
        //        onRefresh()
        OkGo.getInstance().cancelTag(LOADVIRTUALDATE)
        //        refreshLayout.autoRefresh(200)
        onRefresh()
    }
    ...
    private fun networkForGoodsList(page: Int, isLoadMore: Boolean) {
        ...
        request.type = GoldGoodsActivity.TYPE_VIRTUAL
