...
public class PinnedHeaderDecoration extends RecyclerView.ItemDecoration {
    ...
    private void createPinnedHeader(RecyclerView parent) {
        ...
        final int headerPosition = findPinnedHeaderPosition(parent, firstVisiblePosition);
        ...
        if (headerPosition >= 0 && mHeaderPosition != headerPosition) {
            ...
            mPinnedHeaderView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Logger.e("1221212121====" + headerPosition);
