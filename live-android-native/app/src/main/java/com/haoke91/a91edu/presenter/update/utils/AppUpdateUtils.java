package com.haoke91.a91edu.presenter.update.utils;
...
import com.haoke91.a91edu.presenter.update.UpdateAppBean;
    ...
    public static Intent getInstallAppIntent(Context context, File appFile) {
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                ...
                Uri fileUri = FileProvider.getUriForFile(context, context.getApplicationContext().getPackageName() + ".haoke.fileProvider", appFile);
