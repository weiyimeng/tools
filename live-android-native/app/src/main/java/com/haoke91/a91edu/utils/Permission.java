...
public final class Permission {
    ...
    public static final String[] permissionsHint = {"无法获取联系人信息", "无法获取联系人信息", "无法获取联系人信息", "无法开启相机，请开启权限", "无法获取位置，请开启权限", "无法获取位置，请开启权限",
        "无法存储，请开启存储权限", "无法存储，请开启存储权限", "请设置界面开启权限"};
