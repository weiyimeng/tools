package com.haoke91.a91edu.widget.tilibrary.view.image;
...
public class PhotoView extends ImageView {
    ...
    public void setScaleType(ImageView.ScaleType scaleType) {
        ImageView.ScaleType old = mScaleType;
    ...
    public void animaFrom(PhotoInfo info) {
        if (isInit) {
            ...
            if (info.mWidgetRect.width() < info.mImgRect.width() || info.mWidgetRect.height() < info.mImgRect.height()) {
                ...
                ClipCalculate c = info.mScaleType == ImageView.ScaleType.FIT_START ? new START() : info.mScaleType == ImageView.ScaleType.FIT_END ? new END() : new OTHER();
