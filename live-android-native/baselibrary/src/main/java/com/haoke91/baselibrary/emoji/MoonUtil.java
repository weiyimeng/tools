...
public class MoonUtil {
    private static final float DEF_SCALE = 0.4f;
    ...
    public static SpannableString getDrawableSpan(Context context, String value, int align) {
        return replaceEmoticons(context, value, DEF_SCALE, align);
    }
