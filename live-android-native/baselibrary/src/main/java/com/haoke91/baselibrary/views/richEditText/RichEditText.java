package com.haoke91.baselibrary.views.richEditText;
...
public class RichEditText extends MentionEditText {
    ...
    public void resolveTopicText(TopicModel topicModel) {
        ...
        //        SpannableStringBuilder htmlText = new SpanUtils().append(topicModel.getTopicName()).setForegroundColor(Color.parseColor(colorTopic)).create();
        spannableStringBuilder.insert(index, htmlText);
        setText(spannableStringBuilder);
