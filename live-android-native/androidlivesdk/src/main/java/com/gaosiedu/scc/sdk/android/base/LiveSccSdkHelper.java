...
public class LiveSccSdkHelper {
    ...
    public static String makeFullUrl(String path) {
        return Constant.BASEURL_SCC+ "/" + LiveSccSdkConsts.MODEL_PATH + "/" + path;
    }
    ...
    public static HttpHeaders makeHeaders(String path) {
        ...
        //生成sign的参数
        signparams.put("appId", LiveSccSdkConsts.APP_ID);
        ...
        keyString.append(LiveSccSdkConsts.APP_KEY);
        String sign = MD5_LOWERCASE(keyString.toString());
        //添加header
        HttpHeaders httpHeaders = new HttpHeaders();
        httpHeaders.put("appid", LiveSccSdkConsts.APP_ID);
