...
public class BarUtils {
     ...
     * @param color         The status bar's color.
     */
    public static void setStatusBarColor(Context context,@NonNull final View fakeStatusBar,
                                         @ColorInt final int color) {
    ...
    public static void setStatusBarAlpha(@NonNull final View fakeStatusBar) {
        setStatusBarAlpha(fakeStatusBar.getContext(),fakeStatusBar, DEFAULT_ALPHA);
    }
    ...
    public static void setStatusBarAlpha4Drawer(@NonNull final Activity activity,
        ...
        drawer.setFitsSystemWindows(false);
        transparentStatusBar(activity);
        setStatusBarAlpha(activity,fakeStatusBar, isTop ? alpha : 0);
        for (int i = 0, len = drawer.getChildCount(); i < len; i++) {
            drawer.getChildAt(i).setFitsSystemWindows(false);
        }
        if (isTop) {
