...
public class PlaySpeedPopupWindowUtils {
    ...
    public void showPlaySpeedPopupWindow(View view, int width, int height) {
        ...
        View contentView = LayoutInflater.from(activity).inflate(R.layout.popup_play_speed_layout, null);
        ...
        listView.setAdapter(new ArrayAdapter<String>(activity, R.layout.layout_play_speed_item, data));
