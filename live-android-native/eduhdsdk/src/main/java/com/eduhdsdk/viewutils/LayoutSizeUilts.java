...
public class LayoutSizeUilts {
    ...
    public static void videoSize(VideoItem it, RelativeLayout rel_wb_container, int x, int y, double nameLabelHeight) {
        ...
        RelativeLayout.LayoutParams re_bg = (RelativeLayout.LayoutParams) it.re_bg.getLayoutParams();
//        re_bg.width = (int) nameLabelHeight;
//        re_bg.rightMargin = (int) nameLabelHeight;
        re_bg.width = RelativeLayout.LayoutParams.WRAP_CONTENT;
        re_bg.height = RelativeLayout.LayoutParams.WRAP_CONTENT;
        re_bg.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);
        re_bg.addRule(RelativeLayout.CENTER_VERTICAL);
        it.re_bg.setLayoutParams(re_bg);
        ...
        it.img_hand.setLayoutParams(imc);
...
//        nameparam.bottomMargin = linparam.height / 12;
...
//        lin_gift_par.height = (int) nameLabelHeight;
        lin_gift_par.rightMargin = (int) nameLabelHeight;
//        lin_gift_par.bottomMargin = linparam.height / 12;
        it.lin_gift.setLayoutParams(lin_gift_par);

        RelativeLayout.LayoutParams txt_name_par = (RelativeLayout.LayoutParams) it.txt_name.getLayoutParams();
    ...
    public static void moveVideoSize(VideoItem it, double printWidth, double printHeight, double nameLabelHeight) {
       ...
       /* sf_videoParam.width = (int) printWidth;
        sf_videoParam.height = (int) (printHeight - nameLabelHeight);*/
        it.sf_video.setScalingType(RendererCommon.ScalingType.SCALE_ASPECT_FIT);
        it.sf_video.setLayoutParams(sf_videoParam);
