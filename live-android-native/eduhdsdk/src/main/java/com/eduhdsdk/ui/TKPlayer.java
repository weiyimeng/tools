...
import com.eduhdsdk.viewutils.BarUtils;
 ...
 * 类描述：
 * 创建人：shichengxiang
 * 创建时间：2018/11/22 10:27
 */
public class TKPlayer extends RelativeLayout implements NotificationCenter.NotificationCenterDelegate, View.OnClickListener, IWBStateCallBack, CompoundButton.OnCheckedChangeListener,
    ...
    private RelativeLayout rel_play_back_bar, re_back;
    ...
    TKCallBack mTKCallBack;
    
    public TKPlayer(@NonNull Context context) {
        super(context);
        fillView();
    }
    
    public TKPlayer(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        fillView();
    }
    
    private void fillView() {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.three_activity_many, null);
        addView(view);
    }
    
    public void setTKCallBack(TKCallBack tkCallBack) {
        this.mTKCallBack = tkCallBack;
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        if (MotionEvent.ACTION_DOWN == event.getAction()) {
            ...
            //底部
            int[] l = {0, 0};
            rel_play_back.getLocationInWindow(l);
            int top = l[1];
            
            
            if ((startX < getResources().getDisplayMetrics().widthPixels * 2 / 3 && startY > rel_tool_bar.getBottom() && startY < top)) {
        ...
        //            if (deltaX < -100 && Math.abs(-deltaX + deltaY) > 0 && event.getY() > rel_students.getTop() && event.getX() < rel_students.getRight() && rel_students.getTranslationX() == 0){
        //                ObjectAnimator.ofFloat(rel_students, "translationX", -v_students.getWidth()).start();
        //                if (notMoveVideoItems != null && notMoveVideoItems.size() > 0){
        //                    for (VideoItem item : notMoveVideoItems) {
        //                        TKRoomManager.getInstance().unPlayVideo(item.peerid);
        //                    }
        //                }
        //                v_hideStudents.setVisibility(VISIBLE);
        //            }
        //        }
    ...
    public void onCreate() {
        ...
        RoomSession.getInstance().init(getContext());
        
        initTimeMessage();
        resultActivityBackApp();
        initMediaView();
        
        coursePopupWindowUtils = new ThreeCoursePopupWindowUtils((Activity) getContext(), RoomSession.memberList,
            RoomSession.serial, RoomSession.serial);
        coursePopupWindowUtils.setPopupWindowClick(this);
        
        memberListPopupWindowUtils = new ThreeMemberListPopupWindowUtils((Activity) getContext(), RoomSession.memberList);
        memberListPopupWindowUtils.setPopupWindowClick(this);
        
        chatUtils = new ThreeChatWindowPop((Activity) getContext(), RoomSession.chatList, this);
        chatUtils.setChatPopupWindowClick(this);
        allActionUtils = new ThreeAllActionUtils((Activity) getContext());
        allActionUtils.setAllPopupWindowClick(this);
        playSpeedPopupWindowUtils = new PlaySpeedPopupWindowUtils((Activity) getContext());
        sendGiftPopUtils = new ThreeSendGiftPopUtils((Activity) getContext());
        ...
        txt_hour = rel_tool_bar.findViewById(R.id.txt_hour);
        txt_min = rel_tool_bar.findViewById(R.id.txt_min);
        txt_ss = rel_tool_bar.findViewById(R.id.txt_ss);
        img_back = rel_tool_bar.findViewById(R.id.img_back);
        txt_class_begin = rel_tool_bar.findViewById(R.id.txt_class_begin);
        txt_hand_up = rel_tool_bar.findViewById(R.id.txt_hand_up);
        lin_time = rel_tool_bar.findViewById(R.id.lin_time);
        txt_mao_01 = rel_tool_bar.findViewById(R.id.txt_mao_01);
        txt_mao_02 = rel_tool_bar.findViewById(R.id.txt_mao_02);
        cb_choose_photo = rel_tool_bar.findViewById(R.id.cb_choose_photo);
        ll_top = rel_tool_bar.findViewById(R.id.ll_top);
        re_top_right = rel_tool_bar.findViewById(R.id.re_top_right);
        flipCamera = rel_tool_bar.findViewById(R.id.flip_camera);
        cb_message = rel_tool_bar.findViewById(R.id.cb_message);
        tv_no_read_message_number = rel_tool_bar.findViewById(R.id.tv_no_read_message_number);
        cb_control = rel_tool_bar.findViewById(R.id.cb_control);
        cb_member_list = rel_tool_bar.findViewById(R.id.cb_member_list);
        iv_hand = rel_tool_bar.findViewById(R.id.iv_hand);
        cb_file_person_media_list = rel_tool_bar.findViewById(R.id.cb_file_person_media_list);
        cb_tool_case = rel_tool_bar.findViewById(R.id.cb_tool_case);
        
        
        re_loading = findViewById(R.id.re_laoding);
        loadingImageView = re_loading.findViewById(R.id.loadingImageView);
        tv_load = re_loading.findViewById(R.id.tv_load);
        if (frameAnimation == null) {
            frameAnimation = new FrameAnimation(loadingImageView, getRes(), 100, true, false, getContext());
        }
        
        v_students = (View) findViewById(R.id.v_student);
        rel_students = findViewById(R.id.rel_students);
        rel_parent = findViewById(R.id.rel_parent);
        rel_wb = findViewById(R.id.rel_wb);
        rel_wb_container = findViewById(R.id.rel_wb_container);
        
        //白板全屏右下角视频界面
        rel_fullscreen_videoitem = findViewById(R.id.rel_fullscreen_videoitem);
        fullscreen_sf_video = rel_fullscreen_videoitem.findViewById(R.id.fullscreen_sf_video);
        ...
        fullscreen_bg_video_back = rel_fullscreen_videoitem.findViewById(R.id.fullscreen_bg_video_back);
        fullscreen_img_video_back = rel_fullscreen_videoitem.findViewById(R.id.fullscreen_img_video_back);
        
        //回放界面
        rel_play_back = findViewById(R.id.rel_play_back);
        img_play_back = rel_play_back.findViewById(R.id.img_play_back);
        sek_play_back = rel_play_back.findViewById(R.id.sek_play_back);
        txt_play_back_time = rel_play_back.findViewById(R.id.txt_play_back_time);
        txt_play_back_currenttime = rel_play_back.findViewById(R.id.txt_play_back_currenttime);
        tv_play_speed = rel_play_back.findViewById(R.id.tv_play_speed);
        img_back_play_voice = rel_play_back.findViewById(R.id.img_back_play_voice);
        sek_back_play_voice = rel_play_back.findViewById(R.id.sek_back_play_voice);
        ll_voice = rel_play_back.findViewById(R.id.ll_voice);
        rel_play_back_bar = findViewById(R.id.rel_play_back_bar);
        re_back = rel_play_back_bar.findViewById(R.id.re_back);
        //        re_play_back =  findViewById(R.id.re_play_back);
        tv_back_name = rel_play_back_bar.findViewById(R.id.tv_back_name);
        
        initPlayBackView();
        
        pm = (PowerManager) ((Activity) getContext()).getSystemService(Context.POWER_SERVICE);
        mWakeLock = pm.newWakeLock(PowerManager.SCREEN_DIM_WAKE_LOCK, "My Tag");
        audioManager = (AudioManager) ((Activity) getContext()).getSystemService(Service.AUDIO_SERVICE);
        ...
        //        rel_students.setOnTouchListener(new OnTouchListener() {
        //            @Override
        ...
        //                        ObjectAnimator.ofFloat(rel_students, "translationX", 0, -rel_students.getWidth());
        //                        v_hideStudents.setVisibility(VISIBLE);
        //                    }
        //                }
        //                return false;
        //            }
        //        });
        v_hideStudents.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                ObjectAnimator.ofFloat(rel_students, "translationX", 0).start();
                v_hideStudents.setVisibility(GONE);
                //播放
                if (notMoveVideoItems != null && notMoveVideoItems.size() > 0) {
                    for (VideoItem item : notMoveVideoItems) {
                        TKRoomManager.getInstance().playVideo(item.peerid, item.sf_video, RendererCommon.ScalingType.SCALE_ASPECT_BALANCED);
                    }
                }
            }
        });
        
        huawei = FullScreenTools.hasNotchInScreen(getContext());
        oppo = FullScreenTools.hasNotchInOppo(getContext());
        voio = FullScreenTools.hasNotchInScreenAtVoio(getContext());
        initTeacherView();
        showPlayBackControlView();
        registerIt();
    }
    ...
    public void replaceToolbar(View view) {
        rel_play_back_bar.getChildAt(0).setVisibility(View.GONE);
        rel_play_back_bar.addView(view);
        BarUtils.addMarginTopEqualStatusBarHeight(rel_play_back_bar);
    ...
    private void initTeacherView() {
        ...
        iv_to_left = findViewById(R.id.iv_to_left);
        iv_to_right = findViewById(R.id.iv_to_right);
        iv_to_small = findViewById(R.id.iv_small_white_board);
        iv_to_large = findViewById(R.id.iv_large_white_board);
        cb_fullscreen = findViewById(R.id.cb_large_or_small);
        ...
        tv_raiseHnads = findViewById(R.id.tv_raiseHnads);
        tv_onlyTeacher = findViewById(R.id.tv_onlyTeacher);
        rl_rightSide = findViewById(R.id.rl_rightSide);
        ...
        //                final LinearLayout vdi_teacher =  LayoutInflater.from(this).inflate(R.layout.three_item_video_frame_many, null);
        LinearLayout vdi_teacher = findViewById(R.id.vdi_teacher);
        videoitem_teacher.parent = vdi_teacher;
        videoitem_teacher.sf_video = vdi_teacher.findViewById(R.id.sf_video);
        ...
        videoitem_teacher.img_mic = vdi_teacher.findViewById(R.id.img_mic);
        videoitem_teacher.volume = vdi_teacher.findViewById(R.id.volume);
        videoitem_teacher.img_pen = vdi_teacher.findViewById(R.id.img_pen);
        videoitem_teacher.img_hand = vdi_teacher.findViewById(R.id.img_hand_up);
        videoitem_teacher.cv_draw = vdi_teacher.findViewById(R.id.cv_draw);
        videoitem_teacher.txt_name = vdi_teacher.findViewById(R.id.txt_name);
        videoitem_teacher.txt_gift_num = vdi_teacher.findViewById(R.id.txt_gift_num);
        videoitem_teacher.rel_group = vdi_teacher.findViewById(R.id.rel_group);
        videoitem_teacher.img_video_back = vdi_teacher.findViewById(R.id.img_video_back);
        videoitem_teacher.lin_gift = vdi_teacher.findViewById(R.id.lin_gift);
        videoitem_teacher.lin_name_label = vdi_teacher.findViewById(R.id.lin_name_label);
        videoitem_teacher.icon_gif = vdi_teacher.findViewById(R.id.icon_gif);
        videoitem_teacher.rel_video_label = vdi_teacher.findViewById(R.id.rel_video_label);
        videoitem_teacher.re_background = vdi_teacher.findViewById(R.id.re_background);
        videoitem_teacher.tv_home = vdi_teacher.findViewById(R.id.tv_home);
        videoitem_teacher.bg_video_back = vdi_teacher.findViewById(R.id.bg_video_back);
        videoitem_teacher.view_choose_selected = vdi_teacher.findViewById(R.id.view_choose_selected);
        videoitem_teacher.ll_mic = vdi_teacher.findViewById(R.id.ll_mic);
        videoitem_teacher.ll_draw = vdi_teacher.findViewById(R.id.ll_draw);
        ...
        videoitem_teacher.icon_gif.setVisibility(GONE);
        videoitem_teacher.txt_gift_num.setVisibility(GONE);
    ...
    private void doUnPlayTeaccherView() {
    ...
    private void initTimeMessage() {
        ...
        tms1.message = getResources().getString(R.string.classroom_tip_01_01) + "<font color='#FFD700'>1</font>" + getResources().getString(R.string.classroom_tip_01_02);
        TimeMessage tms2 = new TimeMessage();
        tms2.message = getResources().getString(R.string.classroom_tip_02_01) + "<font color='#FFD700'>1</font>" + getResources().getString(R.string.classroom_tip_02_02);
        TimeMessage tms3 = new TimeMessage();
        tms3.message = getResources().getString(R.string.classroom_tip_03_01) + "<font color='#FFD700'>1</font>" + getResources().getString(R.string.classroom_tip_03_02);
        TimeMessage tms4 = new TimeMessage();
        tms4.message = getResources().getString(R.string.classroom_tip_04_01) + "<font color='#FFD700'>3</font>" + getResources().getString(R.string.classroom_tip_04_02) + "<font color='#FFD700'>2</font>" + getResources().getString(R.string.classroom_tip_04_03);
        TimeMessage tms5 = new TimeMessage();
        tms5.message = getResources().getString(R.string.classroom_tip_05);
    ...
    private void initMediaView() {
        ...
        lin_audio_control = findViewById(R.id.lin_audio_control);
        img_play_mp3 = lin_audio_control.findViewById(R.id.img_play);
        txt_mp3_name = lin_audio_control.findViewById(R.id.txt_media_name);
        txt_mp3_time = lin_audio_control.findViewById(R.id.txt_media_time);
        sek_mp3 = lin_audio_control.findViewById(R.id.sek_media);
        sek_mp3.setPadding((int) (10 * ScreenScale.getWidthScale()), 0, (int) (10 * ScreenScale.getWidthScale()), 0);
        img_voice_mp3 = lin_audio_control.findViewById(R.id.img_media_voice);
        sek_voice_mp3 = lin_audio_control.findViewById(R.id.sek_media_voice);
        sek_voice_mp3.setPadding((int) (10 * ScreenScale.getWidthScale()), 0, (int) (10 * ScreenScale.getWidthScale()), 0);
        ll_close_mp3 = lin_audio_control.findViewById(R.id.ll_close_mp3);
    ...
    private void initPlayBackView() {
        ...
        sek_play_back.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                if (isEnd) {
                    img_play_back.setImageResource(R.drawable.ic_video_play);
                    TKPlayBackManager.getInstance().seekPlayback(0);
                    isPlayBackPlay = false;
                } else {
                    img_play_back.setImageResource(R.drawable.ic_video_stop);
    ...
    public void onStart() {
        ...
        if (!RoomSession.isInRoom) {
            ...
            if (frameAnimation != null) {
                ...
                tv_load.setText(getResources().getString(R.string.joining_classroom_home));
            }
        }
    ...
    private void initViewByRoomTypeAndTeacher() {
        if (RoomSession.roomType == 0) {//一对一
            if (TKRoomManager.getInstance().getMySelf().role == 0) {//老师
                ...
                rel_play_back.setVisibility(View.GONE);
                //                re_play_back.setVisibility(View.GONE);
                cb_control.setVisibility(View.GONE);
                cb_member_list.setVisibility(View.GONE);
                cb_file_person_media_list.setVisibility(View.GONE);
                cb_tool_case.setVisibility(View.GONE);
                mChatView.enableSendMessage(true);
            ...
            if (TKRoomManager.getInstance().getMySelf().role == 0) {//老师
                ...
                mChatView.enableSendMessage(false);
    ...
    private void do1vsnStudentPlayVideo(final RoomUser user, boolean force) {
        ...
        if (!hasSit && user.role != 0) {
            ...
            final LinearLayout vdi_stu = (LinearLayout) LayoutInflater.from(getContext()).inflate(R.layout.three_item_video_frame_many, null);
            stu.parent = vdi_stu;
            stu.sf_video = vdi_stu.findViewById(R.id.sf_video);
            ...
            stu.img_mic = vdi_stu.findViewById(R.id.img_mic);
            stu.volume = vdi_stu.findViewById(R.id.volume);
            stu.img_pen = vdi_stu.findViewById(R.id.img_pen);
            stu.img_hand = vdi_stu.findViewById(R.id.img_hand_up);
            stu.cv_draw = vdi_stu.findViewById(R.id.cv_draw);
            stu.txt_name = vdi_stu.findViewById(R.id.txt_name);
            stu.txt_gift_num = vdi_stu.findViewById(R.id.txt_gift_num);
            stu.rel_group = vdi_stu.findViewById(R.id.rel_group);
            stu.img_video_back = vdi_stu.findViewById(R.id.img_video_back);
            stu.lin_gift = vdi_stu.findViewById(R.id.lin_gift);
            stu.lin_name_label = vdi_stu.findViewById(R.id.lin_name_label);
            stu.icon_gif = vdi_stu.findViewById(R.id.icon_gif);
            stu.rel_video_label = vdi_stu.findViewById(R.id.rel_video_label);
            stu.re_background = vdi_stu.findViewById(R.id.re_background);
            stu.tv_home = vdi_stu.findViewById(R.id.tv_home);
            stu.bg_video_back = vdi_stu.findViewById(R.id.bg_video_back);
            stu.view_choose_selected = vdi_stu.findViewById(R.id.view_choose_selected);
            stu.ll_mic = vdi_stu.findViewById(R.id.ll_mic);
            stu.ll_draw = vdi_stu.findViewById(R.id.ll_draw);
        ...
        for (int i = 0; i < videoItems.size(); i++) {
            ...
            if (videoItems.get(i).peerid.equals(peerid)) {
                if (isDrag) {
                    ...
                    int hid = (rel_students.getHeight() - it.parent.getHeight() - v_students.getHeight());
                    ...
                    if (bottom > rel_students.getHeight()) {
                        ...
                        top = (rel_students.getHeight() - it.parent.getHeight());
                    }
    ...
    private void do1vsnStudentUnPlayVideo(String peerId) {
        ...
        Integer publishState = roomUser.properties.get("publishstate") != null ?
    ...
    private void showStudentControlPop(final View view, final RoomUser user, final int index) {
       ...
       /* if (RoomSession.roomType != 0 && index >= videoItems.size()) {
        ...
        View contentView = LayoutInflater.from(getContext()).inflate(R.layout.three_pop_student_control, null);
        
        ImageView img_up_arr = contentView.findViewById(R.id.up_arr);
        ImageView img_down_arr = contentView.findViewById(R.id.down_arr);
        
        ImageView img_right_arr = contentView.findViewById(R.id.right_arr);
        LinearLayout lin_candraw = contentView.findViewById(R.id.lin_candraw);
        LinearLayout lin_up_sd = contentView.findViewById(R.id.lin_up_sd);
        LinearLayout lin_audio = contentView.findViewById(R.id.lin_audio);
        LinearLayout lin_gift = contentView.findViewById(R.id.lin_gift);
        final ImageView img_candraw = contentView.findViewById(R.id.img_candraw);
        final ImageView img_up_sd = contentView.findViewById(R.id.img_up_sd);
        final ImageView img_audio = contentView.findViewById(R.id.img_audio);
        final TextView txt_candraw = contentView.findViewById(R.id.txt_candraw);
        final TextView txt_up_sd = contentView.findViewById(R.id.txt_up_sd);
        final TextView txt_audio = contentView.findViewById(R.id.txt_audio);
        TextView txt_gift = contentView.findViewById(R.id.txt_gift);
        
        LinearLayout lin_plit_screen = contentView.findViewById(R.id.lin_plit_screen);
        TextView txt_plit_screen = contentView.findViewById(R.id.txt_plit_screen);
        ImageView img_plit_screen = contentView.findViewById(R.id.img_plit_screen);
        ...
        LinearLayout lin_video_control = contentView.findViewById(R.id.lin_video_control);
        final ImageView img_video_control = contentView.findViewById(R.id.img_camera);
        final TextView txt_video = contentView.findViewById(R.id.txt_camera);
        if (user.role == 1) {
        ...
        if (TKRoomManager.getInstance().getMySelf().role == 2) {
            studentPopupWindow = new PopupWindow(KeyBoardUtil.dp2px(getContext(), 150f),
                KeyBoardUtil.dp2px(getContext(), 70f));
        } else {
            studentPopupWindow = new PopupWindow(KeyBoardUtil.dp2px(getContext(), 380f),
                KeyBoardUtil.dp2px(getContext(), 70f));
        }
    ...
    private void showTeacherControlPop(final RoomUser user) {
        ...
        View contentView = LayoutInflater.from(getContext()).inflate(R.layout.three_pop_teacher_control, null);
        ImageView img_up_arr = contentView.findViewById(R.id.up_arr);
        ImageView img_down_arr = contentView.findViewById(R.id.down_arr);
        LinearLayout lin_video_control = contentView.findViewById(R.id.lin_video_control);
        LinearLayout lin_audio_control = contentView.findViewById(R.id.lin_audio_control);
        
        final ImageView img_video_control = contentView.findViewById(R.id.img_camera);
        final ImageView img_audio_control = contentView.findViewById(R.id.img_audio);
        final TextView txt_video = contentView.findViewById(R.id.txt_camera);
        final TextView txt_audio = contentView.findViewById(R.id.txt_audio);
        ...
        //弹框宽度和高度都设置成固定值（dp）
        final PopupWindow popupWindow = new PopupWindow(KeyBoardUtil.dp2px(getContext(), 253f), KeyBoardUtil.dp2px(getContext(), 70f));
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.img_back || id == R.id.re_back) {
            ...
            if (TKRoomManager.getInstance().getMySelf().hasVideo) {
                ...
                Toast.makeText(getContext().getApplicationContext(), getResources().getString(R.string.tips_camera), Toast.LENGTH_SHORT).show();
            }
    ...
    private void showPhotoControlPop() {
        View contentView = LayoutInflater.from(getContext().getApplicationContext()).inflate(R.layout.three_pop_photo_control, null);
        LinearLayout ll_popu_camera = contentView.findViewById(R.id.ll_popu_camera);
        LinearLayout ll_popu_selectphoto = contentView.findViewById(R.id.ll_popu_selectphoto);
        ...
        ll_popu_camera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                isOpenCamera = true;
                isBackApp = true;
                PhotoUtils.openCamera((Activity) getContext());
        ...
        ll_popu_selectphoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                isBackApp = true;
                PhotoUtils.openAlbum((Activity) getContext());
                popupWindowPhoto.dismiss();
            }
        });
                ...
                if (resultCode == -1) {
                    ...
                    try {
                        ...
                        if (!TextUtils.isEmpty(imagePath)) {
                            ...
                            Toast.makeText(getContext().getApplicationContext(), "图片选择失败", Toast.LENGTH_SHORT).show();
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
    ...
    private void do1vsnClassBeginPlayVideo(final RoomUser user, boolean force) {
        ...
        if (!hasSit && user.role != 0) {
            final VideoItem stu = new VideoItem();
            final LinearLayout vdi_stu = (LinearLayout) LayoutInflater.from(getContext().getApplicationContext()).inflate(R.layout.three_item_video_frame_many, null);
            stu.parent = vdi_stu;
            stu.sf_video = vdi_stu.findViewById(R.id.sf_video);
            stu.sf_video.init(EglBase.create().getEglBaseContext(), null);
            stu.sf_video.setZOrderMediaOverlay(true);
    ...
    private void removeMovieFragment() {
        ...
        mediafragmentManager = ((Activity) getContext()).getFragmentManager();
    ...
    private void setWhiteBoradNarrow(boolean isZoom) {
        ...
        videoitem_teacher.sf_video.setZOrderMediaOverlay(true);
        videoitem_teacher.sf_video.setVisibility(VISIBLE);
        TKRoomManager.getInstance().playVideo(videoitem_teacher.peerid, videoitem_teacher.sf_video,
            RendererCommon.ScalingType.SCALE_ASPECT_BALANCED);
    ...
    public void showExitDialog() {
        Tools.threeshowDialog(getContext(), R.string.remind, R.string.logouts, new Tools.OnDialogClick() {
            ...
            public void dialog_ok(Dialog dialog) {
                ...
                dialog.dismiss();
                if (mTKCallBack != null) {
                    mTKCallBack.call(TKCallBack.DESTORY_PLAYER);
                }
            }
        }, 0);
    }
    ...
    public void showClassDissMissDialog() {
        Tools.threeshowDialog(getContext(), R.string.remind, R.string.make_sure_class_dissmiss, new Tools.OnDialogClick() {
            @Override
            public void dialog_ok(Dialog dialog) {
...
*/
            ...
            if (user.peerId.equals(videoItems.get(i).peerid)) {
                ...
                if (user.disablevideo) {
                    ...
                    if (user.getPublishState() == 0 || user.getPublishState() == 1 || user.getPublishState() == 4) {
                        videoItems.get(i).sf_video.setVisibility(View.INVISIBLE);
                        videoItems.get(i).bg_video_back.setVisibility(View.VISIBLE);
                        videoItems.get(i).img_video_back.setVisibility(VISIBLE);
                    } else {
                        videoItems.get(i).sf_video.setVisibility(View.VISIBLE);
                    }
                }
    ...
    private void showGiftAim(final VideoItem item, Map<String, Object> map) {
        ...
        final ImageView img_gift = new ImageView(getContext());
        final GifImageView iv_gif = new GifImageView(getContext());
        ...
        if (map.containsKey("giftinfo")) {
            ...
            try {
                ...
                if (is_gif) {
                    Glide.with(getContext()).asGif().load(img_url).into(new SimpleTarget<com.bumptech.glide.load.resource.gif.GifDrawable>() {
                        @Override
                    ...
                    //                    Glide.with(getContext()).load(img_url).asGif().into(new SimpleTarget<com.bumptech.glide.load.resource.gif.GifDrawable>() {
                    //                        @Override
                    ...
                    Glide.with(getContext()).asBitmap().load(img_url).into(new SimpleTarget<Bitmap>() {
                        @Override
                    ...
                    //                    Glide.with(getContext()).load(img_url).asBitmap().into(new SimpleTarget<Bitmap>() {
                    //                        @Override
    ...
    private void setAnimal(final boolean is_gif, final ImageView img_gift, final GifImageView iv_gif, View lin_gift) {
        ...
        if (is_gif) {
            ...
            gy = hid / 2 - iv_gif.getHeight() + KeyBoardUtil.dp2px(getContext(), 5);
        } else {
            gx = wid / 2 - img_gift.getWidth();
            gy = hid / 2 - img_gift.getHeight() + KeyBoardUtil.dp2px(getContext(), 5);
        }
        ...
        ((Activity) getContext()).runOnUiThread(new Runnable() {
            ...
            public void run() {
                synchronized (this) {
                    ...
                    fullscreen_video_param.rightMargin = KeyBoardUtil.dp2px(getContext(), 8);
                    fullscreen_video_param.bottomMargin = KeyBoardUtil.dp2px(getContext(), 8);
                    ...
                    if (RoomSession.maxVideo > 7) {
                        students_param.height = (dm.widthPixels - rightw - 7 * 14) / 11 * hid_ratio / wid_ratio;
                    } else {
                        students_param.height = (dm.widthPixels - rightw - 7 * 8) / 6 * hid_ratio / wid_ratio;
                    }
                    students_param.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM);
                    v_students.setLayoutParams(students_param);
                    //                    RelativeLayout.LayoutParams students_lp = (LayoutParams) rel_students.getLayoutParams();
                    //                    students_lp.height = students_param.height;
                    //                    rel_students.setLayoutParams(students_lp);
                    setWhiteBoard(scale);
    ...
    public void setWhiteBoard(int scale) {
        ...
        if (huawei || oppo || voio) {
            heightStatusBar = FullScreenTools.getStatusBarHeight(getContext());
    ...
    private void do1vsnStudentVideoLayout() {
        ...
        int rightw = rl_rightSide.getWidth();
        if (huawei || oppo || voio) {
            int heightStatusBar = FullScreenTools.getStatusBarHeight(getContext());
        ...
        for (int i = 0; i < notMoveVideoItems.size(); i++) {
            ...
            if (RoomSession.maxVideo > 7) {
                linparam.width = (wid - rightw - 7 * 14) / 11;
            } else {
                linparam.width = (wid - rightw - 7 * 8) / 6;
            }
            ...
            if (RoomSession.maxVideo > 7) {
                layout.width = (wid - rightw - 7 * 14) / 11;
            } else {
                layout.width = (wid - rightw - 7 * 8) / 6;
            }
            ...
            int leftmargin = 8;
            //            if (RoomSession.maxVideo > 7){
            //                leftmargin = 8 * (i + 1) + ((wid - rightw - 7 * 14) / 11) * i;
            //            } else{
            //                leftmargin = 8 * (i + 1) + ((wid - rightw - 7 * 8) / 6) * i;
            //            }
            int firstLeftMargin = (wid - rightw - 8 * (notMoveVideoItems.size() - 1) - layout.width * notMoveVideoItems.size()) / 2;
            int margin = leftmargin * (i * 2 + 1) + layout.width * i;
            if (i == 0) {
            ...
            //            layout.topMargin = 8;
            layout.topMargin = v_students.getTop();
                ...
                try {
                    if (TKRoomManager.getInstance().getRoomProperties() != null &&
                        ...
                        if (TKRoomManager.getInstance().getMySelf().role == 0 && RoomControler.haveTimeQuitClassroomAfterClass()) {
                            Toast.makeText(getContext(), getResources().getString(R.string.end_class_time), Toast.LENGTH_LONG).show();
                        }
                    }
                ...
                try {
                    ...
                    if (TKRoomManager.getInstance().getRoomProperties().getString("companyid").equals("10035")) {
                        ...
                        if (isstart && proTime <= 60 && !timeMessages.get(2).isShowed) {
                            ...
                            txt_hour.setTextAppearance(getContext(), R.style.time_yel);
                            txt_min.setTextAppearance(getContext(), R.style.time_yel);
                            txt_ss.setTextAppearance(getContext(), R.style.time_yel);
                            txt_mao_01.setTextAppearance(getContext(), R.style.time_yel);
                            txt_mao_02.setTextAppearance(getContext(), R.style.time_yel);
                        }
                        if (isstart && proTime <= -3 * 60 && !timeMessages.get(3).isShowed) {
                            showTimeTipPop(timeMessages.get(3));
                            txt_hour.setTextAppearance(getContext(), R.style.time_red);
                            txt_min.setTextAppearance(getContext(), R.style.time_red);
                            txt_ss.setTextAppearance(getContext(), R.style.time_red);
                            txt_mao_01.setTextAppearance(getContext(), R.style.time_red);
                            txt_mao_02.setTextAppearance(getContext(), R.style.time_red);
                        }
    ...
    private void showTimeTipPop(final TimeMessage tms) {
        ...
        tms.isShowed = true;
        View contentView = LayoutInflater.from(getContext().getApplicationContext()).inflate(R.layout.time_tip_pop, null);
        final TextView txt_tip = contentView.findViewById(R.id.txt_tip);
        final TextView txt_i_know = contentView.findViewById(R.id.txt_i_know);
    ...
    public void registerIt() {
        ...
        ((Activity) getContext()).registerReceiver(mBroadcastReceiver, intentFilter);
    }
    ...
    public void resultActivityBackApp() {
        nm = (NotificationManager) ((Activity) getContext()).getSystemService(Context.NOTIFICATION_SERVICE);
        mBuilder = new NotificationCompat.Builder(getContext());
        mBuilder.setTicker(getResources().getString(R.string.app_name));
        mBuilder.setSmallIcon(R.drawable.ic_launcher);
        mBuilder.setContentTitle(getResources().getString(R.string.app_name));
        mBuilder.setContentText(getResources().getString(R.string.back_hint));
        //设置点击一次后消失（如果没有点击事件，则该方法无效。）
        mBuilder.setAutoCancel(true);
        //点击通知之后需要跳转的页面
        Intent resultIntent = new Intent(getContext(), OneToManyThreeActivity.class);
        PendingIntent pIntent = PendingIntent.getActivity(
            getContext().getApplicationContext(), 0, resultIntent,
    ...
    private void onConnectionLost() {
        ...
        if (frameAnimation != null) {
            frameAnimation.playAnimation();
            tv_load.setText(getResources().getString(R.string.connected));
        }
    ...
    private void onError(int errorCode, String errMsg) {
        if (errorCode == 10004) {  //UDP连接不同
            ((Activity) getContext()).runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Tools.threeShowAlertDialog((Activity) getContext(), getResources().getString(R.string.udp_alert), 0);
                }
            });
            ...
            ((Activity) getContext()).runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Tools.threeShowAlertDialog((Activity) getContext(), getResources().getString(R.string.fire_wall_alert), 0);
    ...
    private void onRoomJoin() {
        ...
        if (RoomSession.trophyList != null && RoomSession.trophyList.size() > 0) {
            SoundPlayUtils.loadTrophy(RoomSession.host, RoomSession.port, getContext());
        } else {
            if (TextUtils.isEmpty(RoomSession._MP3Url)) {
                SoundPlayUtils.init(getContext());
            } else {
                SoundPlayUtils.loadMP3(RoomSession.host, RoomSession.port, getContext());
            }
        }
        ...
        if (!PermissionTest.cameraIsCanUse()) {
            Tools.threeshowDialog(getContext(), R.string.remind, R.string.camera_hint, new Tools.OnDialogClick() {
                @Override
                public void dialog_ok(Dialog dialog) {
                    dialog.dismiss();
                }
        ...
        if (PermissionTest.getRecordState() == -2) {
            Tools.threeshowDialog(getContext(), R.string.remind, R.string.mic_hint, new Tools.OnDialogClick() {
                @Override
                public void dialog_ok(Dialog dialog) {
                    dialog.dismiss();
                }
        ...
        mTKCallBack.call(TKCallBack.ONROOMJOIN);
    }
    ...
    public void showPlayBackControlView() {
        final boolean isLiving = TKRoomManager.getInstance().getMySelf().role != -1;
        if (is_show_control_view) {
            displayStatusBar(true);
            is_show_control_view = false;
            if (isLiving) {
                backView(rl_menu);
                ObjectAnimator.ofFloat(rel_students, "translationY", -rel_play_back.getMeasuredHeight()).start();
            } else {
            ...
            is_show_control_view = true;
            if (isLiving) {
                moveDownView(rl_menu);
                ObjectAnimator.ofFloat(rel_students, "translationY", 0).start();
            } else {
                moveDownView(rel_play_back);
            }
            moveUpView(rel_play_back_bar);
            displayStatusBar(false);
        }
    }
    ...
    private void displayStatusBar(boolean b) {
        ...
        //            if (b){
        //                ((Activity) getContext()).getWindow().getDecorView().setSystemUiVisibility(WindowManager.LayoutParams.FLAG_LAYOUT_IN_SCREEN);
        //                ((Activity) getContext()).getWindow().getDecorView().setSystemUiVisibility(WindowManager.LayoutParams.FLAG_LAYOUT_NO_LIMITS);
        //            } else{
        //                ((Activity) getContext()).getWindow().getDecorView().setSystemUiVisibility(View.INVISIBLE);
        //            }
        //        } else{
        //            ((Activity) getContext()).getWindow().getDecorView().setSystemUiVisibility(WindowManager.LayoutParams.FLAG_FULLSCREEN);
        //        }
        if (b) {
            ...
            BarUtils.setStatusBarColor((Activity) getContext(), Color.parseColor("#000000"));
            BarUtils.setStatusBarAlpha((Activity) getContext(), 0x44);
        } else {
            ...
            BarUtils.setStatusBarColor((Activity) getContext(), Color.parseColor("#000000"));
            BarUtils.setStatusBarAlpha((Activity) getContext(), 0x00);
        }
    }
    ...
    private void moveUpView(View view) {
        ObjectAnimator animator = ObjectAnimator.ofFloat(view, "translationY", -view.getMeasuredHeight() - ((MarginLayoutParams) view.getLayoutParams()).topMargin);
        animator.setDuration(300);
        animator.start();
    }
    
    private void moveDownView(View view) {
        ObjectAnimator animator = ObjectAnimator.ofFloat(view, "translationY", view.getMeasuredHeight() + ((MarginLayoutParams) view.getLayoutParams()).bottomMargin);
        animator.setDuration(300);
        animator.start();
    }
    ...
    private void
    onUserJoined(RoomUser user, boolean inList) {
        ...
        if (map.containsKey("disablechat")) {
            ...
            if (TKRoomManager.getInstance().getMySelf().peerId.equals(roomUser.peerId)) {
                ...
                if (TKRoomManager.getInstance().getMySelf().properties.containsKey("disablechat")) {
                    boolean is_forbid_chat = (boolean) TKRoomManager.getInstance().getMySelf().properties.get("disablechat");
                    mChatView.enableSay(is_forbid_chat);
                }
            }
        }
    ...
    private void onRemotePubMsg(String name, long pubMsgTS, Object data, boolean inList) {
                            ...
                            ((Activity) getContext()).runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    if (proTime <= -60 && timeMessages != null && timeMessages.size() > 1 && !timeMessages.get(1).isShowed) {
                                        ...
                                        timeMessages.get(1).message = getResources().getString(R.string.classroom_part_01) + "<font color='#FFD700'>" + overtime + "</font> " + getResources().getString(R.string.classroom_part_02);
            ...
            if (TKRoomManager.getInstance().getMySelf().role == 0) {
                ...
                if (u != null) {
                    if (u.properties.containsKey("passivityPublish")) {
                        ...
                        switch (failuretype) {
                            case 1:
                                Toast.makeText(getContext(), R.string.udp_faild, Toast.LENGTH_LONG).show();
                                break;
                            case 2:
                                Toast.makeText(getContext(), R.string.publish_faild, Toast.LENGTH_LONG).show();
                                break;
                            case 3:
                                Toast.makeText(getContext(), R.string.member_overload, Toast.LENGTH_LONG).show();
                                break;
                            case 4:
                                Toast.makeText(getContext(), u.nickName + getResources().getString(R.string.select_back_hint), Toast.LENGTH_LONG).show();
                                break;
                            case 5:
                                Toast.makeText(getContext(), R.string.udp_break, Toast.LENGTH_LONG).show();
                                break;
                        }
                    }
        ...
        if (name.equals("EveryoneBanChat")) {
            ...
            ch.setMessage(getResources().getString(R.string.chat_prompt_yes));
            ch.setTrans(false);
    ...
    private void onRemoteDelMsg(String name, long delMsgTS) {
        ...
        if (name.equals("EveryoneBanChat")) {
            ...
            ch.setStystemMsg(true);
            ch.setMsgTime(System.currentTimeMillis());
            ch.setMessage(getResources().getString(R.string.chat_prompt_no));
            ch.setTrans(false);
            SimpleDateFormat formatter = new SimpleDateFormat("HH:mm");
            Date curDate = null;
            if (StringUtils.isEmpty(RoomSession.path)) {
